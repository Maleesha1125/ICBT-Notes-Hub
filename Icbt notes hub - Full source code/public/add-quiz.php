...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/add-quiz-style.css">
    ...
    <div class="quiz-card">
        ...
        <form action="add-quiz.php" method="POST">
            <div class="form-group">
                <label for="module_id"><i class="fas fa-book-open"></i> Select Module:</label>
            ...
            <div class="form-group">
                <label for="duration"><i class="fas fa-clock"></i> Duration (in minutes):</label>
                <input type="number" name="duration" id="duration" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Add Quiz</button>
        </form>
    </div>
</div>
</body>
