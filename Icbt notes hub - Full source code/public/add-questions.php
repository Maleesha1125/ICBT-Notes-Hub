...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/add-questions-style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
</head>
<body>
<div class="container">
    <h2><i class="fas fa-question-circle"></i> Add Questions to Quiz: <?php echo htmlspecialchars($quiz_data['title']); ?></h2>
    <hr>
    <div class="button-group">
        <a href="manage-quizzes.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Quizzes</a>
        <a href="add-questions.php?quiz_id=<?php echo $quiz_id; ?>&action=done" class="btn btn-success"><i class="fas fa-check-circle"></i> Done Adding Questions</a>
    </div>
    <hr>
    ...
    <div class="question-list">
        <h3><i class="fas fa-list-ul"></i> Current Questions</h3>
    ...
    <hr>
    <form action="add-questions.php?quiz_id=<?php echo $quiz_id; ?>" method="POST" class="add-question-form">
        ...
        <div class="form-group">
            ...
            <div id="options-container">
                <div class="option-item">
                    ...
                    <input type="radio" name="correct_option" value="0" required> <i class="fas fa-check-circle"></i> Correct
                </div>
                <div class="option-item">
                    <input type="text" name="options[]" placeholder="Option 2" required>
                    <input type="radio" name="correct_option" value="1"> <i class="fas fa-check-circle"></i> Correct
                </div>
                <div class="option-item">
                    <input type="text" name="options[]" placeholder="Option 3" required>
                    <input type="radio" name="correct_option" value="2"> <i class="fas fa-check-circle"></i> Correct
                </div>
                <div class="option-item">
                    <input type="text" name="options[]" placeholder="Option 4" required>
                    <input type="radio" name="correct_option" value="3"> <i class="fas fa-check-circle"></i> Correct
                </div>
            </div>
        </div>
