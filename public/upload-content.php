...
<div class="container upload-content-container">
    <h2 class="text-center my-4">Upload Content for <?php echo htmlspecialchars($module['name']); ?></h2>
    <?php if ($success): ?>
    ...
    <div class="upload-form-card">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="link" class="form-label">Related Links</label>
                <input type="url" id="link" name="link" class="form-control">
            </div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="dashboard_student.php" class="btn btn-secondary me-md-2">Back to Home</a>
